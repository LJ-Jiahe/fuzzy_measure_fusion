...
def plot_NPP(MSEs_unseen_by_num_source, params, output_dir):
        ...
        for distribution_idx, distr in enumerate(distributions):
            for avg_idx, avg_name in enumerate(avg_names[num_source]):
                for model_idx, model_name in enumerate(model_names):
                    ...
                    # plt.xticks(x_seen)
                    ax.set_title('Model=' + model_name + ', Distr=' + distr + ', NumSource=' + str(num_source) + ', Avg Func=' + avg_name)
                    ...
                    plt.savefig(output_dir + 'NPP ' + model_name + '-' +distr + '-' + 'NumSource=' + str(num_source) + ' Avg Func=' + str(avg_name) + '.png')
